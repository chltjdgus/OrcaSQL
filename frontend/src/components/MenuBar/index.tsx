...
interface Props {
  ...
  onShowDbOverview?: () => void
  onShowPerfInsights?: () => void
  onOpenSettings?: () => void
}
      ...
      items: [
        {
          ...
          submenu: [
            ...
            {
              label: t('menuDbOverview', language),
              action: () => onShowDbOverview?.(),
            },
            {
              label: t('menuPerfInsights', language),
              action: () => onShowPerfInsights?.(),
            },
          ],
        },
        {
