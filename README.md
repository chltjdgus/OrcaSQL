...
최신 설치 파일은 [Releases](https://github.com/chltjdgus/OrcaSQL/releases/latest) 에서 받으세요.
...
> 최신 설치 파일은 [Releases](https://github.com/chltjdgus/OrcaSQL/releases/latest) 에서 다운로드할 수 있습니다.

### Windows

1. [Releases](https://github.com/chltjdgus/OrcaSQL/releases/latest) 페이지에서 `OrcaSQL-{버전}-Setup.msi` 다운로드
2. 다운로드한 `.msi` 파일 실행
3. 설치 마법사 안내에 따라 진행
...
1. [Releases](https://github.com/chltjdgus/OrcaSQL/releases/latest) 페이지에서 `OrcaSQL.dmg` 다운로드
...
별도 자동 업데이트 기능은 없습니다. 새 버전이 출시되면 [Releases](https://github.com/chltjdgus/OrcaSQL/releases/latest)에서 최신 설치 파일을 다운받아 재설치하세요.
...
프리 — 모든 용도(개인·상업·재배포·수정·역공학) 자유롭게 허용.
